...
const style = `
    <style>
    nav{margin-top: 50px; text-align: center; margin-bottom: 20px;}
    nav a{margin: 20px;}
...
const nav = `
 <nav>
    <a href="/" target="_self" title="Home Page">Home</a>
    <a href="/users" target="_self" title="User List">Users</a>
 </nav>
`;
    ...
    switch(url){
        ...
        case '/create-user':
            ...
            req.on('end', () => {
                ...
                users.push(user);
                file('json', JSON.stringify(users), 'users');
            });
            res.statusCode = 302;
